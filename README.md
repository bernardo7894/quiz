...
**Model:** [Qwen/Qwen3.5-0.8B](https://huggingface.co/Qwen/Qwen3.5-0.8B) loaded locally via [Transformers.js](https://huggingface.co/docs/transformers.js).
...
| Model | `Qwen/Qwen3.5-0.8B` (q4 quantised) |
